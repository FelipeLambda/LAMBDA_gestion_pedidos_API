    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarios', to='Empresas.area', verbose_name='Área')),
            ...
            options={
                ...
                'permissions': (('ver_usuarios_empresa', 'Puede ver usuarios de su empresa'), ('crear_usuario_empresa', 'Puede crear usuarios en su empresa'), ('editar_usuario_empresa', 'Puede editar usuarios de su empresa'), ('asignar_permisos_validador', 'Puede asignar permisos de validador'), ('gestionar_todos_usuarios', 'Puede gestionar todos los usuarios del sistema')),
            },
        ),
    ]
